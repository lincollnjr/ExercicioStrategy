 ...
 * @author Lincoln
 */
public class MaisSulExpressao extends ExpressaoAbstrata {
    
    private List<Expressao> listExpressao;
    
    public MaisSulExpressao(List<Expressao> listExpressao) {
        this.listExpressao = listExpressao;
        this.proximaDirecao = new MaisLesteExpressao(listExpressao);
        this.direcao = "sul";
    }
