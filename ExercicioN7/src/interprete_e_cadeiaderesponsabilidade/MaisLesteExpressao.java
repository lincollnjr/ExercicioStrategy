 ...
 * @author Lincoln
 */
public class MaisLesteExpressao extends ExpressaoAbstrata{
    
    private List<Expressao> listExpressao;
    
    public MaisLesteExpressao(List<Expressao> listExpressao) {
        this.listExpressao = listExpressao;
        this.proximaDirecao = new MaisOesteExpressao(listExpressao);
        this.direcao = "leste";
    }
